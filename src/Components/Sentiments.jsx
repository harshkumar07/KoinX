...
function Sentiments() {
  return (
    <div className='s:w-full p-2  max-h-max'>
      ...
      <div className='flex gap-2 text-slate-500 text-xl mt-6 font-semibold'>
        <div className='pb-2'>Analyst Estimation</div>
        <div className='my-auto'><IoMdInformationCircle className='my-auto'/></div>
      </div>
       ...
       <div className='s:p-7 sm:p-14 max-h-max py-auto rounded-full s:mr-2 sm:mr-4 md:mr-8 s:w-1/3 s:h-1/3 my-auto md:w-32 md:h-32 mt-4 bg-green-100 text-green-600 font-semibold flex items-center justify-center text-2xl'>
  76%
</div>


        <div  className='my-auto flex flex-col s:gap-1 sm:gap-2  text-slate-600'>
        <div className='my-auto s:text-sm sm:text-base flex s:gap-3 sm:gap-6 w-96'><div>Buy</div> <div className=" s:w-1/3 sm:w-1/2 my-auto h-2 rounded-full bg-green-500"></div> <div>76%</div></div>
        <div className='my-auto s:text-sm sm:text-base flex s:gap-2 sm:gap-4 w-96'><div>Hold</div> <div className="s:w-8 my-auto flex h-2 rounded-full bg-slate-500"></div> <div>8%</div></div>
        <div className='my-auto s:text-sm sm:text-base flex s:gap-3 sm:gap-6 w-96'><div>Sell</div> <div className="s:w-16 my-auto h-2 rounded-full bg-red-500"></div> <div>16%</div></div>
        </div>
        </div> 
